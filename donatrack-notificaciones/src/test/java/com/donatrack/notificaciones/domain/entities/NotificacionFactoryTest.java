 ...
 *
 * <p>Verifica que la factory crea notificaciones con los parámetros correctos, tanto con medio de
 * envío como sin él.
 */
public class NotificacionFactoryTest {
  ...
  public void testCrearNotificacionSinMedio() {
    Evento evento = new Evento(TipoEvento.MISION_CUMPLIDA, "Misión completada", List.of("DONANTE"));

    Notificacion notif =
        NotificacionFactory.crearNotificacion(evento, "donante@test.com", "¡Felicidades!");
  ...
  public void testCrearNotificacionConMedio() {
    Evento evento =
        new Evento(TipoEvento.CAMBIO_CATEGORIA, "Subiste de categoría", List.of("DONANTE"));

    Notificacion notif =
        NotificacionFactory.crearNotificacion(
  ...
  public void testNotificacionCreadaNoEstaCompletada() {
    Evento evento =
        new Evento(
            TipoEvento.INICIO_RUTA_LOGISTICA, "Ruta iniciada", List.of("DONANTE", "BENEFICIARIO"));
