...
public class RabbitMQConfig {
  ...
  @Bean
  public Binding bindingNotifRutaIniciada(
      Queue rutaIniciadaNotifQueue, TopicExchange donacionesExchange) {
    return BindingBuilder.bind(rutaIniciadaNotifQueue)
        .to(donacionesExchange)
        .with("notificacion.inicio.ruta");
  }
  ...
  @Bean
  public Binding bindingNotifEntregaExitosa(
      Queue entregaExitosaNotifQueue, TopicExchange donacionesExchange) {
    return BindingBuilder.bind(entregaExitosaNotifQueue)
        .to(donacionesExchange)
        .with("notificacion.entrega.exitosa");
  }
  ...
  @Bean
  public Binding bindingNotifEntregaFallida(
      Queue entregaFallidaNotifQueue, TopicExchange donacionesExchange) {
    return BindingBuilder.bind(entregaFallidaNotifQueue)
        .to(donacionesExchange)
        .with("notificacion.entrega.fallida");
  }
