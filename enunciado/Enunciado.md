...
UTN.BAurwensinan reovorocawcou || 585%«srenasDE INFORMACION 

Trabajo Práctico Anual 2026 

## **Tabla de contenido** 

Tabla de contenido.................................................................................................................................................. 1 Marco General Trabajo Práctico Anual.................................................................................................................. 3 Prólogo ................................................................................................................................................................. 3 Decálogo de Consideraciones para el Trabajo Práctico Anual ........................................................................ 4 Contexto general ..................................................................................................................................................... 6 Marco Institucional.............................................................................................................................................. 6 Contexto ............................................................................................................................................................... 6 Nuestro sistema .................................................................................................................................................. 6 Entregas ............................................................................................................................................................... 8 Requerimientos mínimos de UI/UX del TP Anual ................................................................................................. 9 Acceso.................................................................................................................................................................. 9 Persona donante ................................................................................................................................................. 9 Entidad beneficiaria............................................................................................................................................. 9 Persona administradora ................................................................................................................................... 10 ENTREGA 1: Arquitectura y Modelado en Objetos - Parte I ............................................................................... 11 Objetivos de la entrega ..................................................................................................................................... 11 Unidades del Programa Vinculadas ................................................................................................................. 11 Alcance ............................................................................................................................................................... 11 Dominio .............................................................................................................................................................. 11 Servicio de Donaciones - Donantes .............................................................................................................. 11 Servicio de Donaciones - Registro de personas donantes ......................................................................... 12 Servicio de Donaciones - Donaciones y segmentación .............................................................................. 12 Servicio de Donaciones - Entidades beneficiarias y necesidades ............................................................. 12 Servicio de Donaciones - Importación masiva de personas donantes por CSV ....................................... 13 Bocetos de interfaz de usuario ..................................................................................................................... 13 Requerimientos detallados ............................................................................................................................... 14 Entregables ........................................................................................................................................................ 14 ENTREGA 2: Arquitectura  y Modelado en Objetos - Parte II ............................................................................. 15 Objetivos de la entrega ..................................................................................................................................... 15 Unidades del Programa Vinculadas ................................................................................................................. 15 Alcance ............................................................................................................................................................... 15 Dominio .............................................................................................................................................................. 15 Servicio de Donaciones - Estados de las donaciones ................................................................................ 15 
...
Servicio de Donaciones - Asignación de las donaciones ........................................................................... 16 Servicio de Incentivos - Analítica de donantes ............................................................................................ 16 Servicio de Incentivos - Recompensas ........................................................................................................ 17 Servicio de Incentivos - Difusión de Insignias y ranking mensual ............................................................. 17 Servicio de Notificaciones ............................................................................................................................ 17 Eventos e integración con medios de notificación (Parte I) ...................................................................... 18 Exposición REST de los servicios - Parte I ................................................................................................... 18 Requerimientos detallados ............................................................................................................................... 19 Entregables ........................................................................................................................................................ 19 Anexo - Links de interés ........................................................................................................................................ 20 
...
A partir de la problemática identificada y presentada en la sección anterior, se propone el diseño y desarrollo de _**DonaTrack**_ : una solución digital orientada a organizar, registrar y monitorear las donaciones desde su recepción en el depósito de la organización hasta su entrega a entidades beneficiarias que las requieran. El objetivo del sistema será mejorar la distribución de recursos y, al mismo tiempo, fortalecer la confianza de personas donantes y entidades beneficiarias de las donaciones. 

6 

LOGICA. NACIONAL, DISENO DE SISTEMAS reso suewos anes” | DE INFORMACION 

Trabajo Práctico Anual 2026 

En este marco, diseñaremos e implementaremos una arquitectura distribuida en servicios: 

- un _**servicio de gestión de personas donantes, entidades beneficiarias y donaciones (en adelante, Servicio de Donaciones)**_ , que permitirá el alta, baja y modificación de personas donantes (humanas o jurídicas), registro de donaciones con trazabilidad y auditoría de estados y de entidades beneficiarias. 

- un _**servicio de logística y gestión de camiones y entregas (en adelante, Servicio de Logística)**_ , que garantizará la generación de rutas de los camiones de la organización para la entrega de las donaciones y la trazabilidad de las mismas durante este proceso. 

- un _**servicio de incentivos a donantes y misiones**_ ( **en adelante, Servicio de Incentivos** ), que integrará funcionalidades de analítica para procesar la actividad de donación, calcular el progreso de los donantes y otorgar incentivos simbólicos como insignias y ascensos de categoría. 

- un _**servicio de notificaciones**_ , que permitirá envío de notificaciones por distintos medios ante cambios de estado de las donaciones, asignaciones, entregas de donaciones realizadas y recompensas desbloqueadas. 

- un _**servicio de autenticación**_ ; 

- un _**componente de front para server-side rendering**_ **(se explicará en la entrega V).** 
...
_Figura 1 - Diagrama de Despliegue Inicial (orientativo)_ 
...
vaereororeecwceUTN.BA ||S588.DE INFORMACION zremas 

Trabajo Práctico Anual 2026 

## Entregas 

El trabajo se organiza en seis entregas. Las primeras incorporan funcionalidades de manera incremental, mientras que, a medida que avanza el desarrollo, las entregas se orientan a refinar el diseño e integrar herramientas y aspectos tecnológicos necesarios para su implementación real  (por ejemplo, persistencia, exposición de una API REST, observabilidad, integración con una interfaz de usuario y seguridad). 
...
|---|---|---|
|**1**|Arquitectura y Modelado en Objetos - Parte I y Diseño de la<br>Interfaz de Usuario|22 de Mayo|
|**2**|ArquitecturayModelado en Objetos - Parte II|19 de Junio|
|**3**|Arquitectura y Modelado en Objetos - Parte III|3 de Julio|
|**4**|PersistenciayMaquetado de Interfaz de Usuario|Semana del 14 de Septiembre|
|**5**|Arquitectura Web MVC|Semana del 19 de Octubre|
|**6**|Despliegue, ObservabilidadySeguridad|Semana del 23 de Noviembre|



_(*) - Estas fechas son a modo de referencia, se podrán realizar modificaciones a medida que avance el curso. Las consignas específicas de cada entrega estarán disponibles en fechas a definir en el curso._ 
...
**1.** El sistema debe contar con una _landing page[1]_ accesible públicamente que permita: 
...
> 1 El término landing page significa **página de aterrizaje o de destino** . Su misión es ser el lugar donde “aterrizan” los usuarios luego de interactuar con una campaña de atracción que los lleva a la plataforma web. 
...
eectUTN.BAmeas, ||S588. DE INFORMACION zremas 
...
|---|---|---|---|---|---|
|HUMANA|DNI|12345678|Ana Pérez|ana@mail.c<br>om|+54 11 5555-5555|
|JURIDICA|CUIT|30-12345678-9 Arcos Plateados S.A.|30-12345678-9 Arcos Plateados S.A.|contacto@e<br>mpresa.com|+54 11 4444-4444|
|Con estos datos debe ser posible ubicar a la<br>persona donante en el sistema. En caso<br>contrario, se le debe crear un usuario.|||Se puede utilizar este archivo de pruebade 20.000 filas.|||



## Bocetos de interfaz de usuario 

Nuestro sistema contará con una interfaz web accesible para personas donantes, entidades beneficiarias y personas administradoras de la plataforma. Con el objetivo de familiarizarse con ella, sus flujos, y usuarios 

13 

neereesoreeereeiiesUTN.BA ||S588. DE INFORMACION zremas 

Trabajo Práctico Anual 2026 

finales, se solicita realizar bocetos de las principales interfaces de usuario del sistema, utilizando como punto de partida la especificación de requerimientos mínimos. 
...
- Familiarizarse con el concepto de APIs como mecanismo de integración y su consumo, y exponer servicios a través de un protocolo de red. 
...
- Servicio de Incentivos – Primera iteración del Servicio de Analítica de Donantes y Sistema de Recompensas. 
...
Si no se la pudo entregar el día estipulado, quedará en estado “Entrega fallida” y volverá al depósito. Si esto sucediera, se solicita registrar una justificación de por qué no se realizó la entrega, por ejemplo: “Tocamos timbre pero nadie respondió”. 

15 

Trabajo Práctico Anual 2026 

ssiiwekcocaLINIVERSIDAD TECNOLOGICAmassNACIO! | DE INFORMACION 

Las personas administradoras encargadas del depósito podrán cambiar el estado de una donación a “Vencida”, en caso de que sea necesario. 

## _Figura 2 - Diagrama de Estados de una donación._ 

## Servicio de Donaciones - Asignación de las donaciones 

Por cada una de las donaciones cuyo estado sea **“En Depósito”** , el sistema debe ejecutar un proceso de _matchmaking_ con el objetivo de asignar el destino de las mismas, es decir, a qué entidad beneficiaria será entregada. 
...
Este servicio tiene como objetivo consolidar y analizar los datos de donaciones realizadas en nuestro sistema para generar métricas de impacto y comportamiento, y a partir de ellas implementar un sistema de incentivos basado en misiones y categorías. Su finalidad es, por un lado, brindar a las personas donantes información clara y detallada sobre su participación en la plataforma y, por otro, incentivar el uso sostenido mediante elementos de gamificación. Asimismo, deberá poner a disposición de las personas administradoras información agregada que permita evaluar la evolución general del sistema. 

La persona donante, ya sea humana o representante de una persona jurídica, además de contar con sus datos personales, podrá observar en su perfil sus totales históricos de donaciones, gráficos de evolución por período, comparaciones mensuales y el número total de organizaciones que ha ayudado con sus aportes. También podrá visualizar su posición en el ranking de donantes activos, así como indicadores que reflejen su impacto acumulado dentro de la plataforma. 
...
En paralelo, el servicio incorporará un sistema de incentivos asociado al cumplimiento de misiones. Se establecen tres categorías de donante: **Colaborador, Sostenedor y Transformador** y dicha categoría será visible públicamente junto al nombre de usuario. 

Para subir de categoría, las personas donantes deberán completar una serie de misiones específicas. Las misiones se completan en **orden secuencial** dentro de cada categoría: al completar una misión, se desbloquea la siguiente. 

Cada misión completada le otorga a la persona donante una _**insignia**_ , la cual podrá verse en su perfil en caso de que las configure como visibles. 
...
- **Donaciones Exitosas** : lograr X donaciones que sean recibidas exitosamente por una entidad beneficiaria. 

El donante deberá poder visualizar en todo momento el progreso de su misión actual y la distancia restante respecto del objetivo establecido. Se deberá contemplar que ciertas misiones, como “Racha”, pueden perder el progreso acumulado ante determinadas condiciones (por ejemplo, si no se realiza ninguna donación durante un mes completo). 

En esta entrega, se solicita realizar la integración entre el Servicio de Donaciones y el Servicio de Incentivos, de modo que las donaciones impacten en el cálculo de progreso y permitan marcar como completadas aquellas misiones cuya condición dependa de la actividad de donación. En próximas entregas, se solicitará la integración con el Servicio de Logística. 

## Servicio de Incentivos - Difusión de Insignias y ranking mensual 

Para incentivar el crecimiento orgánico de DonaTrack, se incorporará un mecanismo de automatización que permita publicar y difundir hitos relevantes de los donantes. Cada vez que una persona donante obtenga una insignia, el sistema activará automáticamente un flujo de procesamiento. Este flujo recibirá un texto descriptivo y generará una imagen asociada a la insignia obtenida. Posteriormente, publicará el contenido en una red social, mencionando al usuario correspondiente para dar visibilidad al logro[2] . 

Adicionalmente, al cierre de cada mes, un flujo programado ejecutará un proceso de ranking mensual de donantes más activos, calculado en función de la cantidad de misiones cumplidas durante ese período (sin importar la categoría). Como resultado, el sistema persistirá el ranking del mes y destacará a los tres primeros en una sección visible de la aplicación. 

## Servicio de Notificaciones 

Para esta entrega, se solicita exponer un componente notificador que, dado un destinatario, un mensaje y un medio de notificación (correo electrónico, SMS y WhatsApp), pueda realizar el envío. En esta iteración, se 

> 2 Para esta implementación, se solicita la integración con una herramienta de automatización de flujos _“low-code”_ (por ejemplo: n8n). 
...
solicita simular la llamada a los servicios externos y marcar a las notificaciones como completadas. En próximas iteraciones se realizará la integración real. 

## Eventos e integración con medios de notificación (Parte I) 

El sistema deberá enviar notificaciones a personas donantes y entidades beneficiarias cuando ocurra un evento considerado relevante. 

Cada servicio que produzca dichos eventos deberá integrarse con el Servicio de Notificaciones para emitir el mensaje correspondiente. Para esta entrega, se requiere notificar en los siguientes casos: 

- A una persona donante, cuando no registre interacción con la plataforma durante más de 20 días, con el objetivo de incentivar a realizar una nueva donación. (Servicio de Donaciones) 

- A una entidad beneficiaria, cuando se le asigna una donación en base a sus necesidades recurrentes o extraordinarias. (Servicio de Donaciones) 

- A una persona donante, cuando haya realizado una donación que acaba de ser asignada a una entidad beneficiaria. (Servicio de Donantes) 
...
En esta iteración, además, se solicita que se envíen notificaciones a las personas usuarias involucradas, a través de correo electrónico, SMS y/o WhatsApp. 
...
**2.** El sistema debe garantizar el envío de notificaciones por distintos medios ante registro de inactividad por parte de una persona donante, asignación de donaciones a la entidad beneficiaria y a la persona donante al cumplir una misión. 
...
**5.** El sistema debe permitir la realización de operaciones a través de los _endpoints_ solicitados, mediante el desarrollo de una API REST. 

**6.** El sistema debe incorporar un mecanismo de automatización para la publicación en redes sociales cuando una persona donante recibe una insignia. 
