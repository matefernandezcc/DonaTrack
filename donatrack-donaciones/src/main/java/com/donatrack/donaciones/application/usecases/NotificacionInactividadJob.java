...
public class NotificacionInactividadJob {
  ...
  public NotificacionInactividadJob(
      PersonaRepository personaRepository, ServicioNotificaciones servicioNotificaciones) {
