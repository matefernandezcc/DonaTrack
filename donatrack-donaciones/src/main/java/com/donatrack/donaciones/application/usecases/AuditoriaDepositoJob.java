...
public class AuditoriaDepositoJob {
  ...
  /**
   * Audita las donaciones en estado EN_DEPOSITO buscando bienes vencidos. Si algún bien de la
   * donación está vencido, marca la donación entera como VENCIDA. Se ejecuta diariamente a la 1 AM.
   */
  @Async
  @Scheduled(cron = "0 0 1 * * ?")
  public void auditarVencidos() {
    List<Donacion> donacionesEnDeposito =
