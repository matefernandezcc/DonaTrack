...
public record CambioEstadoRequestDTO(
    @Schema(
            description = "Nuevo estado de la donación. Valores: EN_DEPOSITO, ASIGNADA, LISTA_PARA_ENTREGAR, EN_TRASLADO, ENTREGADA, ENTREGA_FALLIDA, VENCIDA",
            example = "EN_TRASLADO",
            requiredMode = Schema.RequiredMode.REQUIRED)
        EstadoDonacion nuevoEstado,
    @Schema(description = "Observación del cambio de estado", example = "Cambio de estado manual por administrador")
        String observacion,
