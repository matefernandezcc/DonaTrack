...
public class NecesidadRecurrente extends Necesidad {
    ...
    public NecesidadRecurrente(String descripcion, Categoria subcategoriaRequerida, double cantidadObjetivo, double periodo) {
        super(descripcion, subcategoriaRequerida);
        this.cantidadObjetivo = cantidadObjetivo;
        this.periodo = periodo;
    }

    public LocalDate FechaVencimientoPeriodo () { return this.getFechaSolicitud().plusDays((long) this.periodo);}
