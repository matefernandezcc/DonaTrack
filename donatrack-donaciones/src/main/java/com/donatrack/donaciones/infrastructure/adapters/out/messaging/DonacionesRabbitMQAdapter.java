...
public class DonacionesRabbitMQAdapter {
  ...
  public void handleNotificacionInicioRutaEvent(NotificacionInicioRutaEvent event) {
    log.info(
        "Recibido evento local NotificacionInicioRutaEvent para rutaId: {}. Publicando en RabbitMQ...",
        event.getRutaId());
    rabbitTemplate.convertAndSend(
        RabbitMQConfig.DONACIONES_EXCHANGE, "notificacion.inicio.ruta", event);
  ...
  public void handleNotificacionEntregaExitosaEvent(NotificacionEntregaExitosaEvent event) {
    log.info(
        "Recibido evento local NotificacionEntregaExitosaEvent para donacionId: {}. Publicando en RabbitMQ...",
        event.getIdDonacion());
    rabbitTemplate.convertAndSend(
        RabbitMQConfig.DONACIONES_EXCHANGE, "notificacion.entrega.exitosa", event);
  ...
  public void handleNotificacionEntregaFallidaEvent(NotificacionEntregaFallidaEvent event) {
    log.info(
        "Recibido evento local NotificacionEntregaFallidaEvent para donacionId: {}. Publicando en RabbitMQ...",
        event.getIdDonacion());
    rabbitTemplate.convertAndSend(
        RabbitMQConfig.DONACIONES_EXCHANGE, "notificacion.entrega.fallida", event);
  ...
  public void handleDonacionReplanificadaEvent(DonacionReplanificadaEvent event) {
    log.info(
        "Recibido evento local DonacionReplanificadaEvent para donacionId: {}. Publicando en RabbitMQ...",
        event.getIdDonacion());
    rabbitTemplate.convertAndSend(
        RabbitMQConfig.DONACIONES_EXCHANGE, "donacion.replanificada", event);
