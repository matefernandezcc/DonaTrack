...
public class RabbitMQConfig {
  ...
  @Bean
  public Binding bindingEntregaRealizada(
      Queue entregaRealizadaQueue, TopicExchange logisticaExchange) {
    return BindingBuilder.bind(entregaRealizadaQueue)
        .to(logisticaExchange)
        .with("entrega.realizada");
  }
