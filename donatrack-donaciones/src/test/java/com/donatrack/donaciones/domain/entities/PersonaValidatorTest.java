...
public class PersonaValidatorTest {
  ...
  void setUp() {
    ...
    Direccion direccion =
        new Direccion("Calle Falsa", 123, "Springfield", provincia, "1234", coordenada);
    DocumentoIdentidad documento = new DocumentoIdentidad(TipoDocumento.DNI, "43637832");
    Contacto contacto =
        new Contacto("test@test.com", "123456789", "987654321", MedioContacto.CORREO);

    persona =
        new PersonaHumana("test@test.com", contacto, direccion, documento, "Juan", "Pérez", 30);
  }
