...
public class CompatibilidadSemanticaTest {
  ...
  public void testDonacionMatcheaNecesidadMismaSubcategoria() {
    ...
    NecesidadExtraordinaria necesidad =
        new NecesidadExtraordinaria("Necesitamos ropa", subRopa, 10);

    List<ResultadoMatch> matches =
        strategy.recomendarNecesidades(List.of(donacion), List.of(necesidad));
  ...
  public void testDonacionNoMatcheaNecesidadDistintaSubcategoria() {
    Donacion donacion = new Donacion(subRopa);
    NecesidadExtraordinaria necesidad =
        new NecesidadExtraordinaria("Necesitamos alimentos", subAlimentos, 10);
  ...
  public void testDonacionMatcheaSoloPrimeraNecesidadCompatible() {
    ...
    List<ResultadoMatch> matches =
        strategy.recomendarNecesidades(List.of(donacion), List.of(necesidad1, necesidad2));
  ...
  public void testMultiplesDonacionesYNecesidades() {
    ...
    NecesidadExtraordinaria necesidadAlimentos =
        new NecesidadExtraordinaria("Alimentos", subAlimentos, 20);

    List<ResultadoMatch> matches =
        strategy.recomendarNecesidades(
            List.of(donacionRopa, donacionAlimentos), List.of(necesidadRopa, necesidadAlimentos));
