...
public class SegmentadorTest {
  ...
  private Bien crearBien(
      String descripcion, Subcategoria sub, LocalDate fechaVencimiento, Boolean esUsado) {
    Bien bien =
        new Bien(descripcion, 1.0, "unidad", esUsado != null ? esUsado : false, fechaVencimiento);
