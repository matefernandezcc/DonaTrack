...
public class PrioridadASubAtendidosTest {
  ...
  public void testAsignaciónPorOrdenPosicional() {
    ...
    List<ResultadoMatch> matches = strategy.recomendarNecesidades(List.of(d1, d2), List.of(n1, n2));
  ...
  public void testMasDonacionesQueNecesidades() {
    ...
    List<ResultadoMatch> matches = strategy.recomendarNecesidades(List.of(d1, d2, d3), List.of(n1));
  ...
  public void testMasNecesidadesQueDonaciones() {
    ...
    List<ResultadoMatch> matches = strategy.recomendarNecesidades(List.of(d1), List.of(n1, n2, n3));
