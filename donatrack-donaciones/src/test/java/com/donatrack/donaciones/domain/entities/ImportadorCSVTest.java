 ...
 *
 * <p>Valida la importación de donantes (PersonaHumana y PersonaJuridica) desde CSV sin depender de
 * archivos externos del sistema de archivos.
 */
public class ImportadorCSVTest {
  ...
  public void testImportarActualizaPersonaExistente() {
    ...
    PersonaHumana existente =
        new PersonaHumana("ananavarro@test.com", null, null, null, "Ana", "Navarro", 30);
