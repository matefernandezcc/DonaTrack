...
public class ProcesarInicioRutaUseCaseTest {
  ...
  public void sePublicaEventoConContactosDeDonantesYEntidades() {
    ...
    Contacto contactoDonante =
        new Contacto("donante@test.com", "3333", "4444", MedioContacto.CORREO);
    PersonaHumana personaDonante =
        crearPersona("donante@test.com", contactoDonante, "Donante", "Test");
    ...
    ArgumentCaptor<NotificacionInicioRutaEvent> captor =
        ArgumentCaptor.forClass(NotificacionInicioRutaEvent.class);
  ...
  public void donacionInexistenteSeSaltea() {
    ...
    assertDoesNotThrow(
        () -> useCase.procesar(UUID.randomUUID(), "AA-123-BB", "Carlos", List.of(idInexistente)));
