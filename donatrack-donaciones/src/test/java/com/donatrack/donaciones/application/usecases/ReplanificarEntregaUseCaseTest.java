...
public class ReplanificarEntregaUseCaseTest {
  ...
  public void publicaEventoDeReplanificacion() {
    ...
    ArgumentCaptor<DonacionReplanificadaEvent> captor =
        ArgumentCaptor.forClass(DonacionReplanificadaEvent.class);
  ...
  public void lanzaExcepcionSiDonacionNoExiste() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> useCase.replanificar(idInexistente, "admin-001"));
    verify(donacionRepo, never()).guardar(any());
  }
}
