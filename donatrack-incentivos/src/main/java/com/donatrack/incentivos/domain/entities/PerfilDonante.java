...
public class PerfilDonante {
  ...
  /**
   * Procesa la inactividad del donante verificando si pasaron más de 30 días desde su última
   * donación. Si es así, se resetean los registros (racha cortada).
   *
   * <p>Corrección: antes se comparaba por YearMonth (mes calendario), ahora se usa LocalDate para
   * calcular exactamente 30 días como pidió el profesor.
   *
