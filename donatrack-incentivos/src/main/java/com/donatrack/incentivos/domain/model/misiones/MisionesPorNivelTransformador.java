...
public class MisionesPorNivelTransformador extends MisionesPorNivel {
    ...
    public MisionesPorNivelTransformador() {
        this.categoriaObtener = CategoriaDonante.TRANSFORMADOR;
        this.misiones.add(new Mision("Lograr 10 donaciones exitosas",
                new Insignia("Leyenda", "10 donaciones exitosas."), TipoMetricaMision.DONACIONES_EXITOSAS, 10));
        this.misiones.add(new Mision("Completitud 5 categorías",
