...
public class MisionTest {
  ...
  public void testEvaluarDonacionesExitosas() {
    Mision mision =
        new Mision(
            "2 donaciones", new Insignia("Test", "Test"), TipoMetricaMision.DONACIONES_EXITOSAS, 2);
  ...
  public void testEvaluarMaxBienes() {
    Mision mision =
        new Mision(
            "Más de 5 bienes", new Insignia("Test", "Test"), TipoMetricaMision.MAX_BIENES, 5);
    ...
    perfil
        .getMetricas()
        .registrarDonacion(
            new RegistroDonacion(
                UUID.randomUUID(), 3, Set.of("Ropa"), UUID.randomUUID(), YearMonth.now()));
    ...
    perfil
        ...
        .registrarDonacion(
            new RegistroDonacion(
                UUID.randomUUID(), 6, Set.of("Ropa"), UUID.randomUUID(), YearMonth.now()));
  ...
  public void testEvaluarMesesConsecutivos() {
    Mision mision =
        new Mision(
            "Racha 2 meses", new Insignia("Test", "Test"), TipoMetricaMision.MESES_CONSECUTIVOS, 2);
  ...
  public void testEvaluarMesesConsecutivosRachaRota() {
    Mision mision =
        new Mision(
            "Racha 3 meses", new Insignia("Test", "Test"), TipoMetricaMision.MESES_CONSECUTIVOS, 3);
  ...
  public void testEvaluarCategoriasDistintas() {
    Mision mision =
        new Mision(
            ...
            new Insignia("Test", "Test"),
            TipoMetricaMision.CATEGORIAS_DISTINTAS,
            3);
    ...
    perfil
        ...
        .registrarDonacion(
            new RegistroDonacion(
                UUID.randomUUID(), 1, Set.of("Ropa"), UUID.randomUUID(), YearMonth.now()));
  ...
  public void testGetProgresoActual() {
    Mision mision =
        new Mision(
            "5 donaciones", new Insignia("Test", "Test"), TipoMetricaMision.DONACIONES_EXITOSAS, 5);
  ...
  public void testEvaluarConMetricasNull() {
    Mision mision =
        new Mision("Test", new Insignia("Test", "Test"), TipoMetricaMision.DONACIONES_EXITOSAS, 1);
