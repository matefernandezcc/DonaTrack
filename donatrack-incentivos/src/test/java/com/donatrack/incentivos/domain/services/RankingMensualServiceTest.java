 ...
 *
 * <p>Usa Mockito para mockear el PerfilDonanteRepository. La strategy se instancia real
 * (RankingMisionesStrategy) porque es pura lógica de dominio.
 */
public class RankingMensualServiceTest {
  ...
  /**
   * Crea un PerfilDonante con N misiones completadas en el mes indicado. Registra directamente en
   * las métricas del perfil.
   */
