 ...
 *
 * <p>Esta strategy calcula el puntaje de un donante basándose en la cantidad de misiones
 * completadas en un mes dado.
 */
public class RankingMisionesStrategyTest {
  ...
  public void testCalcularPuntajeConMisionesCompletadas() {
    ...
    Mision m1 =
        new Mision("M1", new Insignia("I1", "D1"), TipoMetricaMision.DONACIONES_EXITOSAS, 1);
