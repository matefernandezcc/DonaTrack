...
public class LogisticaRabbitMQAdapter {
  ...
  public void handleRutaIniciadaEvent(RutaIniciadaEvent event) {
    log.info(
        "Recibido evento local RutaIniciadaEvent para rutaId: {}. Publicando en RabbitMQ...",
        event.getRutaId());
  ...
  public void handleEntregaRealizadaEvent(EntregaRealizadaEvent event) {
    log.info(
        "Recibido evento local EntregaRealizadaEvent para donacionId: {}. Publicando en RabbitMQ...",
        event.getIdDonacion());
  ...
  public void handleEntregaNoSatisfactoriaEvent(EntregaNoSatisfactoriaEvent event) {
    log.info(
        "Recibido evento local EntregaNoSatisfactoriaEvent para donacionId: {}. Publicando en RabbitMQ...",
        event.getIdDonacion());
