...
public class PlanificacionScheduler {
    ...
    private final ProcesarPlanificacionesPendientesUseCase procesarPlanificacionesUseCase;

    public PlanificacionScheduler(ProcesarPlanificacionesPendientesUseCase procesarPlanificacionesUseCase) {
    ...
    public void ejecutarPlanificacionDiferida() {
        ...
        try {
            ...
            log.info("Cron job de planificación de rutas diferida finalizado con éxito.");
        } catch (Exception e) {
            log.error("Error al ejecutar el cron job de planificación de rutas diferida", e);
        }
    }
}
