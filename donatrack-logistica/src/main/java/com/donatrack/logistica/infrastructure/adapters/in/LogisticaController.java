...
public class LogisticaController {
    ...
    @ApiResponse(responseCode = "202", description = "Planificación recibida y aceptada para procesamiento diferido")
    ...
    public ResponseEntity<SolicitudPlanificacion> planificar(@RequestBody PlanificarRutasRequest request) {
        ...
        return ResponseEntity.accepted().body(solicitud);
    }
    ...
    public ResponseEntity<Void> callback(@RequestBody CallbackExternoRequest request) {
        procesarCallbackUseCase.procesarCallback(callbackMapper.toCommand(request));
