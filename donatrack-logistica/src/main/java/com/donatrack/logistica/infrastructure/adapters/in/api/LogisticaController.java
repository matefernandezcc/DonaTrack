...
@Tag(
    name = "Logística",
    description = "Gestión de rutas, camiones, choferes, entregas y planificación")
public class LogisticaController {
  ...
  public LogisticaController(
      ListarItemsPendientesPort listarItemsPendientesPort,
  ...
  @Operation(
      ...
      description =
          "Devuelve todos los ítems de donación recepcionados que están pendientes de ser asignados a una ruta de reparto optimizada.")
  @ApiResponse(
      responseCode = "200",
      description = "Lista de ítems pendientes devuelta correctamente")
  ...
  @Operation(
      ...
      description =
          "Registra un nuevo camión en la flota logística con su capacidad de carga y volumen máximo.")
  @ApiResponse(responseCode = "200", description = "Camión registrado exitosamente")
  @ApiResponse(
      responseCode = "400",
      description = "Datos de camión inválidos",
      content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
  @ApiResponse(
      responseCode = "409",
      description = "Patente de camión ya registrada",
      content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
  ...
  @ApiResponse(
      responseCode = "400",
      description = "Datos o formato de patente inválidos",
      content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
  @PutMapping("/camiones/{patente}")
  public ResponseEntity<Void> actualizarCamion(
      @io.swagger.v3.oas.annotations.Parameter(
              description = "Patente del camión (ej: AA123BB)",
              example = "AA123BB")
          @PathVariable
          String patente,
  ...
  @ApiResponse(
      responseCode = "400",
      description = "Patente con formato inválido o camión con dependencias",
      content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
  @DeleteMapping("/camiones/{patente}")
  public ResponseEntity<Void> eliminarCamion(
      @io.swagger.v3.oas.annotations.Parameter(
              description = "Patente del camión a eliminar",
              example = "AA123BB")
          @PathVariable
          String patente) {
  ...
  @Operation(
      ...
      description =
          "Registra un nuevo chofer con su legajo, nombre, apellido y teléfono de contacto.")
  @ApiResponse(responseCode = "200", description = "Chofer registrado exitosamente")
  @ApiResponse(
      responseCode = "400",
      description = "Datos de chofer inválidos",
      content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
  @ApiResponse(
      responseCode = "409",
      description = "Legajo de chofer ya registrado",
      content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
  ...
  @ApiResponse(
      responseCode = "400",
      description = "Legajo inválido o chofer con asignaciones activas",
      content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
  @DeleteMapping("/choferes/{legajo}")
  public ResponseEntity<Void> eliminarChofer(
      @io.swagger.v3.oas.annotations.Parameter(
              description = "Número de legajo del chofer",
              example = "CH-001")
          @PathVariable
          String legajo) {
  ...
  @Operation(
      ...
      description =
          "Cambia el estado de una ruta planificada a 'INICIADA' y asigna el chofer responsable.")
  @ApiResponse(responseCode = "200", description = "Ruta iniciada exitosamente")
  @ApiResponse(
      responseCode = "400",
      description = "Ruta inexistente, chofer no asignado o estado de ruta inválido",
      content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
  @PostMapping("/rutas/{id}/iniciar")
  public ResponseEntity<Void> iniciarRuta(
      @io.swagger.v3.oas.annotations.Parameter(
              description = "Identificador único (UUID) de la ruta",
  ...
  @Operation(
      ...
      description =
          "Devuelve todas las rutas generadas con sus paradas, donaciones asociadas y estado.")
  ...
  @Operation(
      ...
      description =
          "Registra que una donación fue entregada con éxito al beneficiario, adjuntando URLs de fotos de comprobante y la patente del camión utilizado.")
  @ApiResponse(
      responseCode = "200",
      description = "Entrega confirmada y registrada en el historial")
  @ApiResponse(
      responseCode = "400",
      description = "Entrega no encontrada o no pertenece a la ruta activa",
      content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
  @PostMapping("/entregas/{idDonacion}/confirmar")
  public ResponseEntity<Void> confirmarEntrega(
      @io.swagger.v3.oas.annotations.Parameter(
              description = "UUID de la donación entregada",
              example = "31008064-071a-4d7a-ac37-33318f7d9841")
          @PathVariable
          UUID idDonacion,
  ...
  @Operation(
      ...
      description =
          "Registra un intento fallido de entrega (por ejemplo, si el beneficiario no estaba en el domicilio) y determina si puede replanificarse en una próxima ruta.")
  ...
  public ResponseEntity<Void> fallarEntrega(
      @io.swagger.v3.oas.annotations.Parameter(
              description = "UUID de la donación fallida",
              example = "31008064-071a-4d7a-ac37-33318f7d9841")
          @PathVariable
          UUID idDonacion,
      @RequestBody ReportarFallaRequest request) {
    reportarFallaEntregaUseCase.procesar(
        idDonacion, request.getMotivo(), request.isPuedeReplanificarse());
    return ResponseEntity.ok().build();
  }
  ...
  @Operation(
      ...
      description =
          "Toma los ítems pendientes (en lotes de hasta 100) y dispara la solicitud de cálculo de rutas óptimas al optimizador externo.")
  @ApiResponse(responseCode = "200", description = "Planificación iniciada")
  @ApiResponse(
      responseCode = "500",
      description = "Error al comunicarse con el optimizador de rutas",
      content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
  ...
  @Operation(
      ...
      description =
          "Endpoint que recibe el webhook del servicio externo de cálculo de rutas una vez finalizada la optimización.")
  @ApiResponse(responseCode = "200", description = "Rutas generadas y guardadas correctamente")
  @ApiResponse(
      responseCode = "400",
      description = "Solicitud de planificación no encontrada o datos inválidos",
      content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
  @PostMapping("/planificacion/callback")
  public ResponseEntity<Void> procesarCallbackPlanificacion(
      @RequestBody
          com.donatrack.logistica.infrastructure.adapters.in.api.dto.CallbackPlanificacionRequest
              request) {
    procesarCallbackPlanificacionUseCase.procesarCallback(
        request.getIdSolicitud(), request.getRutas());
    return ResponseEntity.ok().build();
  }
  ...
  @Operation(
      ...
      description =
          "Permite que el microservicio de Donaciones o un sistema externo ingrese un ítem de donación con peso, volumen y dirección de destino para ser planificado.")
  @ApiResponse(responseCode = "200", description = "Ítem recepcionado en depósito")
  @ApiResponse(
      responseCode = "400",
      description = "Datos de ítem o coordenadas inválidas",
      content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
  @PostMapping("/planificacion/items")
  public ResponseEntity<Void> recepcionarDonacionLista(
      @RequestBody ItemPlanificacionRequest request) {
    ItemPlanificacion item =
        new ItemPlanificacion(
            request.getIdDonacion(),
            request.getPeso(),
            request.getVolumen(),
            new Direccion(
                request.getCalleDestino(),
                request.getAlturaDestino(),
                request.getLocalidadDestino()));
  ...
  @io.swagger.v3.oas.annotations.media.Schema(
      description = "Solicitud para iniciar una ruta de reparto")
  public static class IniciarRutaRequest {
    @io.swagger.v3.oas.annotations.media.Schema(
        description = "Legajo del chofer asignado",
        example = "CH-001")
  ...
  @lombok.NoArgsConstructor
  @io.swagger.v3.oas.annotations.media.Schema(
      description = "Datos de confirmación de recepción en destino")
  public static class ConfirmarRecepcionRequest {
    @io.swagger.v3.oas.annotations.media.Schema(
        description = "Lista de URLs de fotos comprobantes de la entrega",
        example = "[\"https://fotos.donatrack.org/remito-123.jpg\"]")
    private List<String> fotos;

    @io.swagger.v3.oas.annotations.media.Schema(
        description = "Patente del camión que realizó la entrega",
        example = "AA123BB")
  ...
  @lombok.NoArgsConstructor
  @io.swagger.v3.oas.annotations.media.Schema(
      description = "Reporte de incidencia o fallo en la entrega")
  public static class ReportarFallaRequest {
    @io.swagger.v3.oas.annotations.media.Schema(
        description = "Motivo por el cual no se pudo entregar",
        example = "El beneficiario no se encontraba en el domicilio")
    private String motivo;

    @io.swagger.v3.oas.annotations.media.Schema(
        description = "Indica si la entrega debe reintentarse en una ruta posterior",
        example = "true")
  ...
  @lombok.NoArgsConstructor
  @io.swagger.v3.oas.annotations.media.Schema(
      description = "Datos de un ítem de donación para planificar")
  public static class ItemPlanificacionRequest {
    @io.swagger.v3.oas.annotations.media.Schema(
        description = "UUID de la donación asociada",
        example = "31008064-071a-4d7a-ac37-33318f7d9841")
    ...
    @io.swagger.v3.oas.annotations.media.Schema(
        description = "Volumen total en metros cúbicos (m3)",
        example = "0.5")
    private double volumen;

    @io.swagger.v3.oas.annotations.media.Schema(
        description = "Calle de destino",
        example = "Av. Santa Fe")
    private String calleDestino;

    @io.swagger.v3.oas.annotations.media.Schema(
        description = "Altura o número de puerta",
        example = "1234")
