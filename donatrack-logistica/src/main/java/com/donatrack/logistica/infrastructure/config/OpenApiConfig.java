    ...
    return new OpenAPI()
        .info(
            new Info()
                ...
                .description(
                    "Módulo responsable de la gestión de flota (camiones y choferes), planificación de rutas optimizadas (lotes de ítems y callbacks asíncronos), seguimiento de entregas con fotos de comprobante y reporte de fallas.")
                .version("1.0.0")
                .contact(
                    new Contact()
